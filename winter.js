(() => {
    ...
    draw(ctx){
      ...
      switch(this.shape){
        ...
        case 'snowman':
          ...
          ctx.fill();
          break;
        // star, heart, gift, tree, bell, snowflakeFancy も同様に描画
      }
      ctx.restore();
    }
  }
  ...
  function drawGround(){
    ...
    for(let x=0;x<cw;x++) ctx.lineTo(x,ch-Snowflake.snowHeight[x]);
